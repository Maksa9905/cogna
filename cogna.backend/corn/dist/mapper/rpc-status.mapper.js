...
exports.RpcToHttpMap = {
    ...
    [enum_1.RpcStatus.FAILED_PRECONDITION]: common_1.HttpStatus.BAD_REQUEST,
    [enum_1.RpcStatus.ABORTED]: common_1.HttpStatus.CONFLICT,
    [enum_1.RpcStatus.OUT_OF_RANGE]: common_1.HttpStatus.BAD_REQUEST,
    [enum_1.RpcStatus.UNIMPLEMENTED]: common_1.HttpStatus.NOT_IMPLEMENTED,
