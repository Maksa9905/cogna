...
export interface TicketServiceClient {
  ...
  generateAnswer(request: GenerateAnswerRequest): Observable<GenerateAnswerResponse>;
}
...
export interface TicketServiceController {
  ...
  ): Promise<GenerateAnswerResponse> | Observable<GenerateAnswerResponse> | GenerateAnswerResponse;
}
